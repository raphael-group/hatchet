...
def test_script(_, bams, output_folder):
    ...
    #        '99ed9c2480a6453a73dc29f45a9a30fa'
    ...
    # assert hashlib.md5(open(os.path.join(output_folder, 'bbc/bulk.bbc'), 'rb').read()).hexdigest() == \
    #        '5ff83aadbe247cb45d42358e7d3055aa'
