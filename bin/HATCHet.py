...
def parsing_arguments():
    ...
    parser.add_argument("-eD","--diploidcmax", type=int, required=False, default=6, help="Maximum copy-number value overall segments (default: 6, 0 means inferred from scaled fractional copy numbers)")
    ...
    parser.add_argument("-u","--minprop", type=float, required=False, default=0.03, help="Minimum clone proporion in each sample (default: 0.03)")
