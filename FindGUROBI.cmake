...
# REQUIREMENT 2: Gurobi's must contain either (1) `lib` and `include` directories, (2) a folder named either `linux64` or `macos_universal2` which correspondingly contains `lib` and `include` directories
...
if(EXISTS ${GUROBI_HOME} )
	...
	file( GLOB GUROBI_LIB_FILE ${GUROBI_HOME}/macos_universal2/lib/libgurobi${GUROBI_VER_LIB}.* )
	if( GUROBI_LIB_FILE )
    	    message( "-- Gurobi library " ${GUROBI_LIB_FILE} " found in " ${GUROBI_HOME} "/macos_universal2/lib/" )
    	else()
	    ...
	    if( GUROBI_LIB_FILE )
	        ...
	        message( FATAL_ERROR "libgurobi" ${GUROBI_VER_LIB} ".* not found either in " ${GUROBI_HOME} "/linux64/lib/ or " ${GUROBI_HOME} "/macos_universal2/lib/ or " ${GUROBI_HOME} "/lib, please check the file exists and provide the correct PATH or manually set Gurobi's version. CMake will exit." )
	    endif()
	endif()
    endif()
...
FIND_PATH(GUROBI_INCLUDE_DIR
          ...
          PATHS /usr/local/gurobi751/linux64/include/ /Library/gurobi751/macos_universal2/include/ ${GUROBI_HOME}/linux64/include/ ${GUROBI_HOME}/macos_universal2/include/ ${GUROBI_HOME}/include/
          DOC "Gurobi include directory")

FIND_LIBRARY(GUROBI_CPP_LIB
             NAMES gurobi_c++
             PATHS /usr/local/gurobi751/linux64/lib/ /Library/gurobi751/macos_universal2/lib/ ${GUROBI_HOME}/linux64/lib/ ${GUROBI_HOME}/macos_universal2/lib/ ${GUROBI_HOME}/lib/
